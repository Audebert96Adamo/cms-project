...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            $pending_counts = mysqli_num_rows($select_all_pending_comments);

            $query = "SELECT * FROM users WHERE user_role = 'subscriber'";
            $select_all_user_role = mysqli_query($connection, $query);
            $user_role_counts = mysqli_num_rows($select_all_user_role);
            ...
            <script type="text/javascript">
                ...
                function drawChart() {
                    var data = google.visualization.arrayToDataTable([
                        ...
                        ['Data', 'Count'],
                        <?php
                        $element_text = ['Posts', 'Draft posts', 'Comments', 'Pending comments', 'Users', 'Subscriber users', 'Categories'];
                        $element_count = [$post_counts, $post_draft_counts, $comment_counts, $pending_counts, $users_counts, $user_role_counts, $categories_counts];
